...
def predict_tags(net):
    fname = dump_dir + 'prediction_alex_5.tsv'
    fp = open(fname, 'w')
    num_batches = n_samples/batch_size
    for t in range(num_batches):
        net.forward()
...
def master(model_dir, viz = False):
    ...
    model_def = model_dir + 'test_2k.prototxt'    
    # model_weights = caffe_root + 'models/finetune_flickr_tag/finetune_flickr_tag_1_2_iter_40000.caffemodel'
    # model_weights = caffe_root + 'models/alexnet_flickr_tag/alexnet_flickr_tag_2_iter_440000.caffemodel'
    model_weights = caffe_root + 'models/alexnet_flickr_tag/alexnet_flickr_tag_2k_2_iter_350000.caffemodel'
